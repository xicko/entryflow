...
class AppColors {
  ...
  static const Color lightSearchButtonBorderColor = Color.fromARGB(255, 41, 41, 41);
  static const Color lightSearchButtonForegroundColor = Colors.white;
  static const Color lightSearchButtonIconColor = Color.fromARGB(255, 37, 37, 37);
  ...
  static const Color darkSearchButtonForegroundColor = Color.fromRGBO(33, 33, 33, 1);
  ...
  static Color titleTextColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkTitleTextColor : lightTitleTextColor;
  }
  ...
  static Color searchInputTextColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchInputTextColor : lightSearchInputTextColor;
  }

  static Color searchInputFillColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchInputFillColor : lightSearchInputFillColor;
  }

  static Color searchInputCursorColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchInputCursorColor : lightSearchInputCursorColor;
  }

  static Color searchInputLabelColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchInputLabelColor : lightSearchInputLabelColor;
  }

  static Color searchInputIconColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchInputIconColor : lightSearchInputIconColor;
  }

  static Color searchInputFocusedBorderSideColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchInputFocusedBorderSideColor : lightSearchInputFocusedBorderSideColor;
  }

  static Color searchButtonBorderColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchButtonBorderColor : lightSearchButtonBorderColor;
  }

  static Color searchButtonForegroundColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchButtonForegroundColor : lightSearchButtonForegroundColor;
  }

  static Color searchButtonIconColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkSearchButtonIconColor : lightSearchButtonIconColor;
  }

  static Color itemCardColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkItemCardColor : lightItemCardColor ;
  }

  static Color itemTitleTextColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkItemTitleTextColor : lightItemTitleTextColor;
  }

  static Color itemSubtitleTextColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkItemSubtitleTextColor : lightItemSubtitleTextColor ;
  }
  ...
  static Color nextButtonColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkNextButtonColor : lightNextButtonColor;
  }

  static Color prevButtonColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkPrevButtonColor : lightPrevButtonColor ;
  }

  static Color refreshButtonColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkRefreshButtonColor : lightRefreshButtonColor;
  }

  static Color shareButtonColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkShareButtonColor : lightShareButtonColor ;
  }

  static Color customSnackBarTextColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkCustomSnackBarTextColor : lightCustomSnackBarTextColor ;
  }

  static Color customSnackBarBackgroundColor(Brightness brightness) {
    return brightness == Brightness.dark ? darkCustomSnackBarBackgroundColor : lightCustomSnackBarBackgroundColor ;
  }
}